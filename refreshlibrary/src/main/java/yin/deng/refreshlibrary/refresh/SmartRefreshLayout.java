...
import yin.deng.refreshlibrary.refresh.api.RefreshContent;
...
import yin.deng.refreshlibrary.refresh.api.ScrollBoundaryDecider;
import yin.deng.refreshlibrary.refresh.constant.DimensionStatus;
import yin.deng.refreshlibrary.refresh.constant.RefreshState;
import yin.deng.refreshlibrary.refresh.constant.SpinnerStyle;
import yin.deng.refreshlibrary.refresh.footer.BallPulseFooter;
import yin.deng.refreshlibrary.refresh.header.BezierRadarHeader;
import yin.deng.refreshlibrary.refresh.header.FalsifyHeader;
import yin.deng.refreshlibrary.refresh.impl.RefreshContentWrapper;
import yin.deng.refreshlibrary.refresh.impl.RefreshFooterWrapper;
import yin.deng.refreshlibrary.refresh.impl.RefreshHeaderWrapper;
import yin.deng.refreshlibrary.refresh.listener.OnLoadmoreListener;
import yin.deng.refreshlibrary.refresh.listener.OnMultiPurposeListener;
import yin.deng.refreshlibrary.refresh.listener.OnRefreshListener;
import yin.deng.refreshlibrary.refresh.listener.OnRefreshLoadmoreListener;
import yin.deng.refreshlibrary.refresh.util.DelayedRunable;
import yin.deng.refreshlibrary.refresh.util.DensityUtil;
import yin.deng.refreshlibrary.refresh.util.ViscousFluidInterpolator;
...
public class SmartRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent, NestedScrollingChild {
    ...
    protected int mReboundDuration = 200;
...
//        }
    ...
    public SmartRefreshLayout finishRefresh() {
        return finishRefresh(0);//保证刷新动画有1000毫秒的时间
    }
    ...
    public SmartRefreshLayout finishLoadmore() {
        return finishLoadmore(0,true);//保证加载动画有1000毫秒的时间
    }
    ...
    public SmartRefreshLayout finishRefresh(boolean success) {
        return finishRefresh(0, success);
    }
    ...
    public SmartRefreshLayout finishLoadmore(boolean success) {
        return finishLoadmore(0, success);
    }
